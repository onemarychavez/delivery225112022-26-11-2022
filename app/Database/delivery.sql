...
--
-- Host: localhost:3306
-- Generation Time: Nov 27, 2022 at 02:55 AM
...
(7, 'Oye!', 'Oneyda Chavez', 'Comerciante', '73348625', '483157', 'Comercio', '7logo20220815071704.jpg', 0),
(8, 'prueba', 'oneyda', 'Comerciante', '75157812', '483158', 'Comercio', '8descarga20220821031549.jpg', 0),
(9, 'Pollo Campero', 'Oneyda Chavez', 'servicios', '78451578', '483157-7', 'alimentos', '9pollo20221009115819.png', 1),
(10, 'prueba', 'Oneyda Chavez', 'Comerciante', '78798526', '483157-7', 'Comercio', '10logo120221023060131.png', 0),
(11, 'Wendys', 'Karla Alfaro', 'Alimentos', '7334-8695', '483157-7', 'Comercio', '11WendysLogo20221123112056.jpg', 1);
...
(16, 5, 'PRUEBA1', 1, 1),
(17, 7, 'POLLO', 0, 8),
(18, 7, 'PRUEBA_VIERNES', 0, 6),
(19, 7, 'PRUEBA', 0, 6),
(20, 9, 'PRUEBAUGTGYHU', 1, 2);
...
(13, 18, 'AMBURGUESA', '5.50', '13b620221104083942.png', '[]', 1, 'PRUEBA'),
(14, 19, 'JNJNMK', '0.03', '14logo120221104092604.png', '[]', 1, 'IKNM'),
(15, 20, 'PRUEBAJJJI', '2.50', '15pizza320221125083015.jpg', '[]', 1, 'KNDUBDJ');
...
INSERT INTO `sucursales` (`idsucursal`, `idempresa`, `nombre`, `telefono`, `iddepartamento`, `idmunicipio`, `direccion`, `direccion2`, `direccion3`, `encargado`, `activo`) VALUES
(1, 1, 'prueba', '4578-7898', 1, 1, 'quelepa', 'quela1', 'quelepa3', 'oneyda', 1),
(2, 2, 'prueba2', '4578-7898', 2, 2, 'quelepa', NULL, NULL, 'oneyda', 1),
(3, 6, 'PRUEBA3', '7334-8695', 8, 2, 'QUELEPA', 'HHJK', 'JBJUB', 'INGRIS', 1),
(4, 9, 'JUANITO S.V CENTRO', '7334-8695', 8, 3, 'QUELEPA', '', '', 'INGRIS', 1),
(5, 11, 'SUCURSAL CENTRO1', '7334-3012', 12, 6, 'USULUTAN', '', '', 'CARMEN LOPEZ', 1);
...
(15, 'PRUEBA', 'JAJAJJA', '4521555-7', '1217-065209-7', 'prueba 45', '8K1Odkut8N/WAGCkVu6Yvrsezo3xNSRFDTHHW/WPAByFuHiPlD322LT99dpuUaCfvPzd', 1, 0),
(16, 'JUANITO S.V', 'AJJ', '1223-12-23', '1223-12-23-5', 'juanito', 'Aj1chw06CneR0Qm9B+xr72pBZSqjjGHpTwZf9ESTUfINYe0jvOLqAxmQIfylmlBqL4y9', 2, 0);
...
--
ALTER TABLE `categorias_empresas`
  MODIFY `idcateemp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `menu_detalle`
  MODIFY `idmenudetalle` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
